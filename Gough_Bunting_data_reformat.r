######################################################################
### DATA RESCUE OF GOUGH BUNTING RINGING AND RESIGHTING DATA #########
######################################################################

## written by steffen.oppel@rspb.org.uk
## support from Kate Lawrence

## main purpose is to rescue data that are inefficiently stored in several Excel files
## conversion into flat tables for import into database
## simplification and standardisation of terminology

## first created 22 Sept 2018
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##
## PART 1: READ IN MANUALLY COPIED EXCEL FILES
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##
...
try(setwd("C:\\STEFFEN\\RSPB\\UKOT\\Gough\\DATA\\Landbirds\\BuntingRinging"), silent=T)

inds <- read_excel("BuntingDatabase.xls", sheet="tbl_deployments")
obs <- read_excel("BuntingDatabase.xls", sheet="tbl_encounters")
